...
var _user$project$Gol$flattenedSvgGrid = function (grid) {
	return A3(
		_elm_lang$core$List$foldr,
		F2(
			function (x, y) {
...
var _user$project$Gol$positionOfNeighbors = function (coord) {
	var _p0 = coord;
	var x = _p0._0;
	var y = _p0._1;
	return {
...
var _user$project$Gol$seed = _mgold$elm_random_pcg$Random_Pcg$initialSeed(126781231212);
var _user$project$Gol$Model = F3(
	function (a, b, c) {
		return {height: a, width: b, grid: c};
	});
var _user$project$Gol$Cell = F2(
	function (a, b) {
		return {status: a, position: b};
	});
var _user$project$Gol$StayDead = {ctor: 'StayDead'};
var _user$project$Gol$LiveOn = {ctor: 'LiveOn'};
var _user$project$Gol$Starvation = {ctor: 'Starvation'};
var _user$project$Gol$Overpopulation = {ctor: 'Overpopulation'};
var _user$project$Gol$Reproduction = {ctor: 'Reproduction'};
var _user$project$Gol$Step = {ctor: 'Step'};
var _user$project$Gol$Click = function (a) {
	return {ctor: 'Click', _0: a};
};
var _user$project$Gol$svgSquare = F3(
	function (x, y, color) {
		var newY = _elm_lang$core$Basics$toString(y * 10);
		var newX = _elm_lang$core$Basics$toString(x * 10);
		return A2(
					...
					_1: {
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$x(newX),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$y(newY),
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Events$onClick(
												_user$project$Gol$Click(
...
var _user$project$Gol$Dead = {ctor: 'Dead'};
var _user$project$Gol$Alive = {ctor: 'Alive'};
var _user$project$Gol$neighbors = F2(
	function (cell, grid) {
		var isANeighbor = function (c) {
			return A2(
				_elm_lang$core$List$member,
				c.position,
				_user$project$Gol$positionOfNeighbors(cell.position));
		};
		return A2(
			_elm_lang$core$List$filter,
			function (c) {
				return _elm_lang$core$Native_Utils.eq(c.status, _user$project$Gol$Alive);
			},
			A2(_elm_lang$core$List$filter, isANeighbor, grid));
	});
var _user$project$Gol$nextGenerationStatus = F2(
	function (grid, cell) {
		var sizeOfHood = _elm_lang$core$List$length(
			A2(_user$project$Gol$neighbors, cell, grid));
		if (_elm_lang$core$Native_Utils.eq(cell.status, _user$project$Gol$Alive)) {
			var _p1 = sizeOfHood;
			switch (_p1) {
				case 0:
					return _user$project$Gol$Starvation;
				case 1:
					return _user$project$Gol$Starvation;
				case 2:
					return _user$project$Gol$LiveOn;
				case 3:
					return _user$project$Gol$LiveOn;
				default:
					return _user$project$Gol$Overpopulation;
			}
		} else {
			var _p2 = sizeOfHood;
			if (_p2 === 3) {
				return _user$project$Gol$Reproduction;
			} else {
				return _user$project$Gol$StayDead;
			}
		}
	});
var _user$project$Gol$resetCellStatus = F2(
	function (grid, cell) {
		var community = A2(_user$project$Gol$nextGenerationStatus, grid, cell);
		var newStatus = function () {
			var _p3 = community;
			switch (_p3.ctor) {
				case 'Starvation':
					return _user$project$Gol$Dead;
				case 'LiveOn':
					return _user$project$Gol$Alive;
				case 'Overpopulation':
					return _user$project$Gol$Dead;
				case 'Reproduction':
					return _user$project$Gol$Alive;
...
var _user$project$Gol$stepGrid = function (model) {
	var newGrid = A2(
		_elm_lang$core$List$map,
		_user$project$Gol$resetCellStatus(model.grid),
		model.grid);
	return _elm_lang$core$Native_Utils.update(
		model,
		{grid: newGrid});
};
var _user$project$Gol$toggleStatus = function (status) {
	return _elm_lang$core$Native_Utils.eq(status, _user$project$Gol$Alive) ? _user$project$Gol$Dead : _user$project$Gol$Alive;
};
var _user$project$Gol$toggleClickedCell = F2(
	function (position, cells) {
		return A2(
			_elm_lang$core$List$map,
			function (c) {
				return _elm_lang$core$Native_Utils.eq(c.position, position) ? _elm_lang$core$Native_Utils.update(
					c,
					{
						status: _user$project$Gol$toggleStatus(c.status)
					}) : c;
			},
			cells);
	});
	...
	function (msg, model) {
		...
		if (_p4.ctor === 'Click') {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					grid: A2(_user$project$Gol$toggleClickedCell, _p4._0, model.grid)
				});
		} else {
			return _user$project$Gol$stepGrid(model);
		}
	});
var _user$project$Gol$cellColor = function (cell) {
	return _elm_lang$core$Native_Utils.eq(cell.status, _user$project$Gol$Alive) ? 'blue' : 'white';
};
var _user$project$Gol$renderCell = function (cell) {
	var _p5 = cell.position;
	var x = _p5._0;
	var y = _p5._1;
	return A3(
		_user$project$Gol$svgSquare,
		x,
		y,
		_user$project$Gol$cellColor(cell));
};
var _user$project$Gol$renderGrid = function (row) {
	return A2(_elm_lang$core$List$map, _user$project$Gol$renderCell, row);
};
var _user$project$Gol$view = function (model) {
	var grid = _user$project$Gol$renderGrid(model.grid);
	return A2(
		...
		{ctor: '[]'},
		{
					...
					_0: A2(
						_elm_lang$svg$Svg$svg,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$viewBox('10 10 100 100'),
									_1: {ctor: '[]'}
								}
							}
						},
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Gol$Step),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$Gol$svgRowBuilder = F4(
	function (length, rowNumber, seed, row) {
		svgRowBuilder:
		while (true) {
			if (_elm_lang$core$Native_Utils.eq(length, 0)) {
				return row;
			} else {
				var _p6 = A2(
					_mgold$elm_random_pcg$Random_Pcg$step,
				...
				var seed1 = _p6._1;
				var status = _elm_lang$core$Native_Utils.eq(randomNumber, 0) ? _user$project$Gol$Dead : _user$project$Gol$Alive;
				var newRow = {
					ctor: '::',
					_0: {
						status: status,
						position: {ctor: '_Tuple2', _0: length, _1: rowNumber}
					},
					_1: row
				};
				var _v4 = length - 1,
				...
				seed = _v6;
				row = _v7;
				continue svgRowBuilder;
			}
		}
	});
var _user$project$Gol$svgGridBuilder = F4(
	function (height, width, seed, grid) {
		svgGridBuilder:
		while (true) {
			if (_elm_lang$core$Native_Utils.eq(height, 0)) {
				...
				var newGrid = {
					ctor: '::',
					_0: A4(
						_user$project$Gol$svgRowBuilder,
						width,
						height,
						seed1,
						{ctor: '[]'}),
				...
				seed = _v10;
				grid = _v11;
				continue svgGridBuilder;
			}
		}
	});
var _user$project$Gol$model = function () {
	var w = 10;
	var h = 10;
	var grid = _user$project$Gol$flattenedSvgGrid(
		A4(
			_user$project$Gol$svgGridBuilder,
			h,
			w,
			_user$project$Gol$seed,
			{ctor: '[]'}));
	return {height: h, width: w, grid: grid};
}();
var _user$project$Gol$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$Gol$model, view: _user$project$Gol$view, update: _user$project$Gol$update})();

var Elm = {};
Elm['Gol'] = Elm['Gol'] || {};
if (typeof _user$project$Gol$main !== 'undefined') {
    _user$project$Gol$main(Elm['Gol'], 'Gol', undefined);
}
